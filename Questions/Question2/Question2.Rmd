...
p<- ggplot(joinedDF, aes(x = USDZAR_Returns, y = Portfolio_Returns)) +
    ...
    geom_label(aes(x=-0.1, y=0.1, label = "Hedge works but amplifies volatility"),
