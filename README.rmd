...
The purpose of this repository is to host my Financial Econometrics 871 Practical Exam.

This README contains the code for wrangling for and plotting. Functions are contained within scripts in the code folders of the corresponding questions. The logic and code is explained throughout. After each output, an interpretation is given. For the same interpretations, in a more formal setting, see the pdf files in each question folder.
...
This question investigates returns from an AI Fund, a market benchmark (CAPPED SWIX) and active managers. It aims to shed light on the differences and similarity in return structures through various visualisation techniques. The powerpoint is in the Question 1 folder, as the data folder is "gitignored"
